  ...
  const portalOptions = [
    {
      to: "/login/admin",
      title: "Admin Portal",
      description: "Manage employees, deparments, payroll and sysetm configurations.",
      icon: UserIcon
    },
    {
      to: "/login/employee",
      title: "Employee Portal",
      description: "View your profile, rack attendance, request time off and access payslips.",
      icon: UserIcon
    }
  ]
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="mt-12 text-center md:text-left text-sm text-slate-400">
          <p>© {new Date().getFullYear()} Proj. All rights reserved.</p>
        </div>
      </div>
      </div>
    </div>
